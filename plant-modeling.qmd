...
**General Notes**
- checkout `dotwhisker` package
- cite sources
- 1-3 tables or figures with captions in plain-ish language

# Project Overview

## Motivation
- background and context + why people should care
- state hypothesis
- write out equation (not sure what the best place for this is)
- show figures ect that support hypothesis
